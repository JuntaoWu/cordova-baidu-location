...
public class BaiduLocation extends CordovaPlugin {
  ...
  public static int COARSE_LOCATION = 0;
  public static int FINE_LOCATION = 1;

  protected void getCoarseLocationPermission(int requestCode) {
    PermissionHelper.requestPermission(this, requestCode, permissions[COARSE_LOCATION]);
  }

  private void promptForLocation() {
    if (PermissionHelper.hasPermission(this, permissions[COARSE_LOCATION])
      && PermissionHelper.hasPermission(this, permissions[FINE_LOCATION])) {
      this.getCurrentPosition();
    } else {
      getCoarseLocationPermission(FINE_LOCATION);
    }
  }
